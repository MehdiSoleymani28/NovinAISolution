...
const tools = [
  {
    ...
    description:
      "دریافت ایمیل‌ها را خودکار مانیتور کنید، با AI طبقه‌بندی و پاسخ اولیه بدهید. اتصال Gmail به CRM و ایجاد تیکت خودکار برای تیم پشتیبانی.",
    tag: "پیشنهادی",
  ...
  },
  {
    ...
    description:
      "چت‌باتی که با دانش محصولات شما آموزش دیده و به صورت شبانه‌روزی به مشتریان پاسخ می‌دهد. اتصال به واتساپ، تلگرام و وب‌سایت با یک دستیار یکپارچه.",
    tag: "پیشنهادی",
    tagColor: "bg-blue-500/10 text-blue-500",
    category: "AI Agent",
  },
  {
    ...
    description:
      "از ایده تا محتوای نهایی. تولید خودکار پست شبکه‌های اجتماعی، مقالات بلاگ، خبرنامه و کپشن محصول با تنظیم لحن و سبک سفارشی.",
    tag: "کاربردی",
  ...
  },
  {
    ...
    description:
      "آپلود قراردادها، فاکتورها و اسناد سازمانی و سؤال‌وجواب از روی آنها. جستجوی معنایی در هزاران سند و استخراج خودکار اطلاعات کلیدی.",
    tag: "کاربردی",
    tagColor: "bg-green-500/10 text-green-500",
    category: "RAG System",
  },
  ...
  },
  {
    ...
    description:
      "دستیار AI که لیدهای ورودی را اولویت‌بندی می‌کند، ایمیل‌های فالوآپ خودکار ارسال می‌کند و گزارش پیشرفت فروش را آماده می‌کند.",
    tag: "سازمانی",
    tagColor: "bg-purple-500/10 text-purple-500",

        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <p className="text-muted-foreground leading-relaxed mb-6">
              NovinAISolution با هدف دموکراتیزه کردن استفاده از هوش مصنوعی در
              کسب‌وکارهای ایرانی تأسیس شده. ما معتقدیم برای بهره‌مندی از AI
              نیازی به تیم دیتاساینس یا بودجه‌های کلان نیست.
            </p>
            <p className="text-muted-foreground leading-relaxed mb-8">
              تمرکز ما بر استفاده عملی از ابزارهای آماده هوش مصنوعی مثل
              ChatGPT، Claude، Make، n8n و پلتفرم‌های مشابهه. به جای ساخت مدل از
              صفر، از قدرت مدل‌های موجود استفاده می‌کنیم و ورکفلوها و دستیارهای
              هوشمندی می‌سازیم که کارهای دستی و تکراری سازمان شما رو خودکار کنند.
            </p>

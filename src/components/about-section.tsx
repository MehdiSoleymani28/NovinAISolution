...
const values = [
  ...
  },
  {
    ...
    description:
      "نیازی نیست برنامه‌نویس باشید. ما از ابزارهای آماده و پلتفرم‌های بدون کد استفاده می‌کنیم تا سریع‌ترین و مقرون‌به‌صرفه راهکار را به شما ارائه دهیم.",
  },
  {
    icon: Lightbulb,
    title: "راهکار سفارشی",
    description:
      "هر کسب‌وکاری فرآیندهای منحصربه‌فرد خود را دارد. ما صرفاً یک ابزار نمی‌فروشیم، بلکه راهکاری متناسب با نیاز دقیق شما طراحی و پیاده‌سازی می‌کنیم.",
  },
  {
    icon: Cpu,
    title: "به‌روز و کارآمد",
    description:
      "دنیای AI هر روز تغییر می‌کند و ما همیشه جدیدترین ابزارها و تکنیک‌ها را آزمایش می‌کنیم. فقط راهکارهایی را پیشنهاد می‌دهیم که خودمان تست و تأیید کرده‌ایم.",
  },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <p className="text-muted-foreground leading-relaxed mb-6">
              ...
              برنامه‌نویسی و تیم فنی، می‌تواند از قدرت هوش مصنوعی بهره ببرد.
              تمرکز ما روی استفاده عملی از ابزارهای آماده است، نه ساخت مدل‌های
              پیچیده از صفر.
            </p>
            <p className="text-muted-foreground leading-relaxed mb-8">
              ما کمک می‌کنیم فرآیندهای دستی و تکراری سازمان خود را با ابزارهایی
              مثل Make، n8n، ChatGPT و Claude خودکار کنید. از طراحی ورکفلوهای
              کاری هوشمند تا ساخت دستیارهای AI سفارشی، هر جا کار تکراری هست،
              ما آن را خودکار می‌کنیم.
            </p>
